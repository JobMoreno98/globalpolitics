...
@section('content')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div style="display:flex; justify-content: center;">
                    <h3 class="text-lg font-medium text-gray-800 mb-4">Galeria</h3>
                    </div>
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z"/>
                    ...
                    <!-- tabla que contiene los datos de la consulta a la tabla de galerias -->
                        <div class="flex justify-content">
                            <div class="table-responsive">
                                <table class="table table-striped" id="galerias">
                                  <br>
                                    <thead>
                                        <tr>
                                    ...
                                    @foreach ($galerias as $ga)
                                        <tr class="fila-Galerias">
                                      
                                        <td><img src="{{ $ga->imagen }}" class="img-fluid img-thumbnail" alt="{{ $ga->nombre }}" width="100px"></td>
                                            <td>{{ substr($ga->nombre,0,30) }}</td>
                                            <td>{{ substr($ga->tipo,0,10) }}</td>
                                            ...
                                            <td>
                                                            ...
                                                            <a href="{{ route('ImagenEditar', ['id' => $ga->id]) }}">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                    ...
                                                    <button class="boton-eliminar btn btn-danger" data-toggle="modal" data-target="#modalEliminar{{ $ga->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
  ...
  <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1ZM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118ZM2.5 3h11V2h-11v1Z"/>
                                ...
                                <!-- fin de la consulta tabla galerias -->
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- fin del container de la tabla galerias -->
  ...
  <script>
    //método para hacer responsiva la tabla para dispositivos moviles o tablets
      $('#galerias').DataTable({
        ...
        "language": {
            "lengthMenu": "Mostrar _MENU_ Registro de galerias",
...
<div id="mi-modal">
  <form class="form-group col-md-12"  method="POST"action="{{route('guardarImagenes')}}" enctype="multipart/form-data">
  @csrf
  <br>
  <div class="form-row">
...
<div class="modal fade" id="modalEliminar{{ $ga->id }}" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="modalEliminarLabel">Eliminar Imagen de galería</h5>
...
<img src="{{ $ga->imagen }}" class="img-fluid img-thumbnail" width="100px">
<p><strong>{{ $ga->nombre }}</strong></p>
</div>
<div class="modal-footer">
<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
<a href="{{ route('eliminarimagen', ['id' => $ga->id]) }}" class="btn btn-danger">Eliminar</a>
</div>
</div>
</div>
</div>
